...
export default function Home() {
  ...
  return <div className="mx-auto max-w-6xl py-6"><p className="text-[11px] font-semibold uppercase leading-relaxed tracking-[0.16em] text-ink-dim">Sherlock / your finance review desk</p>
    <div className="mt-6 grid items-start gap-10 xl:grid-cols-[1.5fr_1fr]"><section className="min-w-0"><h1 className="max-w-[20ch] text-balance text-[2.25rem] font-semibold leading-[1.12] tracking-[-0.04em] sm:text-5xl xl:text-[3.25rem]">Know what needs attention.<span className="mt-2 block text-ink-dim">See the evidence behind it.</span></h1>
      <p className="mt-6 max-w-[58ch] text-base leading-7 text-ink-dim">Turn a school’s financial records into a reviewable list of questions, checks and next steps. Inspect every source. Ask your finance team for missing evidence. Keep the final decision human.</p>
    ...
    <aside className="border border-line bg-surface-2 p-6 sm:p-7"><p className="text-[11px] uppercase leading-relaxed tracking-[0.14em]">Judge’s challenge / about 3 minutes</p><h2 className="mt-3 text-balance text-2xl font-semibold leading-snug tracking-tight">Could you explain this month’s exceptions to the board?</h2>
