  ...
  return (
    <section className="w-full">
      <div className="mb-3 flex max-w-2xl flex-col gap-2">
        <div className="flex w-fit items-center gap-1.5 rounded-full border border-teal-500/30 bg-teal-500/10 px-2.5 py-1">
      ...
      <div className="grid gap-2.5 md:grid-cols-4">
            ...
            {agents.map((agent, i) => (
              <button
                ...
                className={cn(
                  ...
                  activeAgent === i
                    ? "border-teal-500/50 bg-surface-2"
                    : "border-line bg-surface hover:border-teal-500/40",
                )}
              >
        ...
        <div className="rounded-[10px] border border-line bg-surface p-3">
          <div className="mb-2 flex items-center justify-between">
            <div className="rounded-md border border-line bg-surface-2 p-1.5">
              <ChartColumn className="h-4 w-4 text-teal-300" aria-hidden />
            </div>
        ...
        <div className="rounded-[10px] border border-line bg-surface p-3">
          <div className="mb-2 w-fit rounded-md border border-line bg-surface-2 p-1.5">
            <Layers className="h-4 w-4 text-teal-300" aria-hidden />
          </div>
      ...
      <div className="mt-2.5 grid grid-cols-2 gap-2.5 md:grid-cols-4">
        {stats.map((stat) => {
          ...
          return (
            ...
            >
              <Icon className="mb-2 h-4 w-4 text-teal-300" aria-hidden />
