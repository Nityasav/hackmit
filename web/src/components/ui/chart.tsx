...
/** The slice of a recharts tooltip entry this component reads. */
type TooltipItem = {
  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "grid min-w-[8rem] items-start gap-2 rounded-lg border border-border/50 bg-background px-2.5 py-2.5 text-xs shadow-xl",
          className,
        )}
      >
                  ...
                  <>
                    ...
                    >
                      ...
                      {item.value !== undefined && (
                        <span className="font-mono font-medium font-num tabular-nums text-foreground">
